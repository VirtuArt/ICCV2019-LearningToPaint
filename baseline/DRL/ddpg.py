...
from baseline.DRL.rpm import rpm
from baseline.DRL.actor import ResNet as ActorResNet
from baseline.DRL.critic import ResNet_wobn as CriticResNet_wobn
from baseline.DRL.wgan import update, load_gan, save_gan, cal_reward
from baseline.Renderer.model import FCN
from baseline.utils.util import hard_update, soft_update, to_tensor, to_numpy
...
class DDPG(object):
    def __init__(self, batch_size=64, env_batch=1, max_step=40, \
        ...
        self.critic = CriticResNet_wobn(3 + 9, 18, 1)  # add the last canvas for better prediction
        self.critic_target = CriticResNet_wobn(3 + 9, 18, 1)
