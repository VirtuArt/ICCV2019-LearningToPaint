...
if(args["image"]):
    ...
    image = cv2.imread('/Users/eyalziv/my_projects/VirtuArt/ICCV2019-LearningToPaint/baseline/pencil_drawing.png')

gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
gray = (gray < 250).astype(np.uint8)
gray = binary_opening(binary_closing(gray))
thresh = cv2.threshold(gray, args["threshold"], 250,
	cv2.THRESH_BINARY)[1]
